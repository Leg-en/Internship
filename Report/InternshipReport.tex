...
{
        name=Spring Boot,
        description={Spring Boot is an open-source Java-based framework used for creating standalone, production-grade Spring-based applications with minimal effort.}
}
\newglossaryentry{azure}
{
        name=Microsoft Azure,
        description={Microsoft Azure, often referred to as Azure is a cloud computing platform run by Microsoft.}
}
