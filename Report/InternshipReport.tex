...
\subsection{\glsxtrfull{dz} - Fire Department Live Data}
My interim paricipation in the \glsxtrshort{dz} Project, was an  the \glsxtrshort{gd} Project and the subsequent Open Pioneer project.
The main goal was to develope an Demonstration of Recorded Firedepartment data.
