...
In the course of the internship is used multiple aspects from my study program. Clearly i needed my software developement Competencies, which were teached in multiple modules. For example i needed to develop software components in Javascript, Java and Python. Basic database competencies were also teached. 

Aspects that were clearly not teached was using Frameworks/Librarys in these Languages. For example in the university it was never teached to use any UI Framework, such as React, Angular or Vue. Therefore i needed to teach me this myself. Also using ORMs for database accesss were never teached but were heavily used. Also developing and planning complete and complex infrastructures were were not part of the study program. Also not teached were concepts such as Reverse Proxys and SSL. Also using GIS in the context of 3D were not really teached.
