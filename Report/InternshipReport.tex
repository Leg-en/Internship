...
{
        name=FastAPI,
        description={FastAPI is a modern, fast (high-performance) web framework for building APIs with Python, leveraging type hints and asynchronous programming for efficient development.}
}
...
{
        name=Vite,
        description={Vite is a build tool that offers a faster and leaner development experience for modern web projects. It provides features such as extremely fast Hot Module Replacement (HMR) and enhancements over native ES modules.}
}
...
{
        name=Nginx,
        description={Nginx is an open-source web server used for serving static or dynamic websites, reverse proxying, load balancing, and other HTTP and proxy server capabilities.}
}
